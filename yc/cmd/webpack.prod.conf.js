...
let plugins = [
    ...
    new ExtractTextPlugin({
        filename: false == true ? utils.assetsPath('css/[name].css') : utils.assetsPath('css/[name].css')
    }),
...
const webpackConfig = merge(baseWebpackConfig, {
    ...
    output: {
        ...
        filename: false == true ? utils.assetsPath('js/[name].js') : utils.assetsPath('js/[name].js'),
        chunkFilename: false == true ? utils.assetsPath('js/[id].js') : utils.assetsPath('js/[id].js')
    },
    plugins
});
